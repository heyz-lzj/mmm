...
NSString *const kJKPickerAssetPropertyALA   = @"kJKPickerAssetPropertyALA";
...
-(id)initWithCoder:(NSCoder *)aDecoder
{
    if(self = [super init])
    {
        ...
        self.alasset = [aDecoder decodeObjectForKey:kJKPickerAssetPropertyALA];
    }
    return self;
}
...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_alasset  forKey:kJKPickerAssetPropertyALA];
}
