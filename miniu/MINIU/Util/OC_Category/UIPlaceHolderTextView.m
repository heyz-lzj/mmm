...
CGFloat const UI_PLACEHOLDER_TEXT_CHANGED_ANIMATION_DURATION_ = 0.25;
...
- (void)textChanged:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:UI_PLACEHOLDER_TEXT_CHANGED_ANIMATION_DURATION_ animations:^{
