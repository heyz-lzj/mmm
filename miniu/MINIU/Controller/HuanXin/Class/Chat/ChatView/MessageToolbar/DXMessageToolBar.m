...
- (void)keyboardWillChangeFrame:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:duration delay:0.2f options:(curve << 16 | UIViewAnimationOptionBeginFromCurrentState) animations:animations completion:completion];
}
...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    if (!self.moreView) {
        ...
        self.moreView.backgroundColor = [UIColor colorWithRed:0.906 green:0.902 blue:0.906 alpha:1];
    ...
    if (!self.faceView) {
        ...
        self.faceView.backgroundColor = [UIColor colorWithRed:0.906 green:0.902 blue:0.906 alpha:1];
