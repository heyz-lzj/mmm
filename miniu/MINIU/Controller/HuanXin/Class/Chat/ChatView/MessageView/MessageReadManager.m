 ...
 */
- (void)zoomPhotoWithURL:(NSURL *)url AndImageView:(UIImageView *)imageView
{
    @try {
        
        [[PhotoZooo shareInstance] showImageWithArray:@[url.absoluteString] setInitialPageIndex:0 withController:kKeyWindow];
    }
