...
//    if (message.ext) {
//        NSDictionary *dict = message.ext;
//        model.OrderId               = dict[@"extOrderId"];
//        model.goodsId               = dict[@"extGoodsId"];
//        model.goodsDescription      = dict[@"extgoodsDescription"];
//        model.goodsPrice            = dict[@"extPrice"];
//        model.goodsFirstImageURL    = dict[@"extFirstImageUrl"];
//        [model setExtMessageTypeWithString:dict[@"extMessageType"]];
//    }
