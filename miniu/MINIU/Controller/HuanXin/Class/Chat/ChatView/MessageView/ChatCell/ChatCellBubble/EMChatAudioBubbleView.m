...
-(CGSize)sizeThatFits:(CGSize)size
{
    ...
    NSInteger audioLenght = [self.model time];
    
    if (audioLenght > 5 && audioLenght < 100) {
        width += (audioLenght - 5) * 2;
    } else if (audioLenght > 100) {
        width += 100;
    }
...
//        frame.origin.x = _animationImageView.frame.origin.x - ANIMATION_TIME_IMAGEVIEW_PADDING - ANIMATION_TIME_LABEL_WIDHT;
        ...
        frame.origin.x = self.backImageView.frame.origin.x + 5;
...
//        frame.origin.x = ANIMATION_TIME_IMAGEVIEW_PADDING + BUBBLE_ARROW_WIDTH + _animationImageView.frame.size.width + _animationImageView.frame.origin.x;
        ...
        frame.origin.x = self.backImageView.frame.origin.x + self.backImageView.frame.size.width - ANIMATION_TIME_LABEL_WIDHT - 5;
