...
- (EMChatBaseBubbleView *)bubbleViewForMessageModel:(MessageModel *)messageModel
{
    ...
    if (messageModel.extMessageType == extMessageType_Goods) {
        return [[EMChatGoodsBubbleView alloc] init];
    } else if (messageModel.extMessageType == extMessageType_Order) {
        return [[EMChatOrderBubbleView alloc] init];
    }
...
+ (CGFloat)bubbleViewHeightForMessageModel:(MessageModel *)messageModel
{
    ...
    if (messageModel.extMessageType == extMessageType_Goods) {
        ...
        return [EMChatOrderBubbleView heightForBubbleWithObject:messageModel];
    }
